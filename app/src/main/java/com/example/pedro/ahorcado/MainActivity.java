...
Reproductor reprod;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reprod = new Reproductor(getApplicationContext());
        crearTeclado();
    }
    ...
    private void crearTeclado(){
        ...
        while (contLetra<letras.length) {
            if(cont==0){
                fila = (TableRow)getLayoutInflater().inflate(R.layout.table_row_teclado,null);
                //fila.setGravity(Gravity.CENTER);
                //fila.setBackgroundColor(getResources().getColor(R.color.fondoTransparencia));
